  ...
  <v-app :style="{background: $vuetify.theme.themes.dark.background}">
    ...
    <v-container>
        <v-toolbar color="rgba(0,0,0,0)" flat>
            ...
            <v-spacer></v-spacer>
            <v-text-field label="Search category or menu..." class="mt-5" color="brown" filled append-icon="mdi-magnify" dense solo flat
            background-color="gray lighten-4"></v-text-field>
        </v-toolbar>
                          ...
                          <v-col cols="12" sm="12">
                            <v-list-item three-line  class="text-center ">
                              <v-list-item-content>
                                ...
                                :class="active ? 'brown--text' : 'black--text'" class=" caption mt-4">ALL
                                </v-list-item-subtitle>
                              </v-list-item-content>
                            </v-list-item>
                          </v-col>
                        ...
                        <v-col cols="12" sm="12">
                          <v-list-item three-line  class="text-center ">
                            <v-list-item-content>
                              ...
                              <v-list-item-subtitle
                                :class="active ? 'brown--text' : 'black--text'" class=" caption mt-3">Coffee
                              </v-list-item-subtitle>
                            </v-list-item-content>
                          </v-list-item>
                        </v-col>
        ...
        <v-toolbar color="#EEEEEE" flat>
            ...
            <span color="grey">12 Coffes Results</span>
        </v-toolbar>
        <v-row>
          <v-col cols="12" sm="6">
                              ...
                              <v-col cols="12" md="4">
                                <v-item v-slot="{active, toggle}">
                                  <v-card  color="#F6EFEF"
                                    ...
                                    <v-list-item class="text-center">
                                      <v-list-item-content>
                                        <v-icon dark color="orange">fab fa-modx</v-icon>
                                      </v-list-item-content>
                                    </v-list-item>
                                  </v-card>
                                </v-item>
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        urlImg1: require('@/assets/CaramelFrappuccino.png'),
        urlImg2: require('@/assets/ChocolateFrappuccino.png')
      }
    }
  }
</script>
